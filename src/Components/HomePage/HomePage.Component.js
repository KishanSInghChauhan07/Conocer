...
const HomePage = () =>{
    return(
        <Card style={{maxWidth:'35%',margin:'20px auto',minWidth:'330px',borderRadius:'5px'}} className="shadow-sm">
            ...
            <img style={{width:'100%',margin:'-20vh 0'}} src="https://images.unsplash.com/photo-1591589406157-e324d83bf5df?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="upload-pic"/>
            </div>
            <div className="m-3">
